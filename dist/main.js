...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _changeOver_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./changeOver.js */ \"./src/changeOver.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\nlet searcher = document.getElementById('searcher');\n\nasync function searchWeather(country) {\n    try{\n        const weatherG = await fetch(`http://api.openweathermap.org/data/2.5/weather?q=${country}&APPID=2fa59fcee881881732ea84b56fe7e565`,{mode:\"cors\"});\n        const valores = await weatherG.json();\n        (0,_changeOver_js__WEBPACK_IMPORTED_MODULE_0__.default)(valores);\n    } catch {\n        alert(\"That location doesn't exist\")\n    }\n}\n\nsearchWeather(\"Argentina\");\n\nsearcher.addEventListener('change',function(e){\n    searchWeather(e.originalTarget.value);\n})\n\n//# sourceURL=webpack://weather_app/./src/index.js?");
